...
gameState.prototype = {
    ...
    update: function () {
        ...
        // we call the arcade physics overlap function to see if our bulletGroup and asteroidGroup bounding boxes overlap. If they do, it calls the asteroidCollision function and passes the overlapping bullet and asteroid sprite as arguments to the asteroidCollision function above.
